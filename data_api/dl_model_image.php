...
// --------------------------------------------------------
	...
	switch( $sExt )
	{
		case 'bmp': $sMime = 'image/bmp'; break;
		case 'emf': $sMime = 'application/x-emf'; break;
		case 'jpeg':
		case 'jpg': $sMime = 'image/jpeg'; break;
		case 'gif': $sMime = 'image/gif'; break;
		case 'png': $sMime = 'image/png'; break;
		case 'wmf': $sMime = 'application/x-msmetafile'; break;
		default: $sMime = 'application/octet-stream';
	}
	ob_end_clean();

...
<body style="overflow: auto">
	...
	if (empty($aMissingModules)) {
		...
		if ($iCnt > 0) {
			...
			echo 			'<img src="images/logo-fif.png">';
			echo 		'</div>';
			echo	'</div>';
			echo 	'<div class="login-header-header">';
			...
			echo 					'<div id="ntlm-button-label">' . _glt('Login with NPK/NPO') . '</div>';
			echo 				'</div>';
			echo 			'</div>';
	...
	<footer>
		<div id="main-footer">
			...
			<div class="main-footer-version"> WebEA v<?php echo g_csWebEAVersion; ?> PT IlmuKomputerCom Braindevs Sistema</div>
		</div>
	</footer>
	<?php
